...
if($r){
    echo "<script>alert('Quiz successfully created!');document.location='AQuiz_Dashboard.php';</script>";
}
else{
    echo"<script>alert('Something went wrong.Please try again.');document.location='AQuiz_create.php';</script>";
}
