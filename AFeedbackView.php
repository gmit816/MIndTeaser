            ...
            <div class="wrapper clearfix">
                <div class="rowbox managecontainer">
                    <div class="row border_bottom manageheader">
                        <div class="col3">
                            <div class="contentbox">
                                <strong class="heading h3">User Feedback</strong>
                            </div>
                        </div>
                        <div class="col9">
                            <div class="row">
                    ...
                    <div class="row">
                            ...
                            <div class="navigation quiznav">
                                <nav>
                                    <ul class="menu level1">
                                        ...
                                        <li class="hier open"><a href="AFeedbackView.php">User Feedback</a></li>
                        ...
                        <div class="col9">
                            <div class="contentbox noLeftPadding">
                                ...
                                $selectSQL = 'SELECT * FROM `feedback_master`';
                                ...
                                <table class="quizindex">
                                    ...
                                    if( mysql_num_rows( $selectRes )==0 ){
                                        ...
                                        while( $row = mysql_fetch_assoc( $selectRes ) ){
                                            echo "<tr><td>{$row['Feedback_id']}</td><td>{$row['Email_ID']}</td><td>{$row['Subject']}</td><td>{$row['Feedback']}</td></tr>\n";
                                        }
                                    }
                                    ?>
                                    </tbody>
