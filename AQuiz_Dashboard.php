<!DOCTYPE html>
<!-- saved from url=(0095)https://www.onlinequizcreator.com/my-dashboard/my-quizzes/quiz-dashboard/item3252?quizId=118985 -->
...
<head>
    ...
    <meta name="title" content="Quiz dashboard">
    <meta name="description" content="Manage your quiz.">
...
<body class="page_dashboard page_content page_qsettings">
<div id="mm-0" class="mm-page mm-slideout"><div class="navbar mainnavbar">
        <div class="wrapper clearfix">
            <img src="" alt="">
            <a class="navlink" id="show-main-navigation" href="https://www.onlinequizcreator.com/my-dashboard/my-quizzes/quiz-dashboard/item3252#"></a>
    ...
    <div class="navbar menubar" style="position: relative;">
        <div class="wrapper clearfix">
            <div class="row">
                <div class="col8">
                    <div class="dashtabs">
                        <a class="navlink" id="show-quizmaster-navigation" href="https://www.onlinequizcreator.com/my-dashboard/my-quizzes/quiz-dashboard/item3252#"></a>
                    ...
                    <div class="col12">
                        <nav>
                            <ul class="crumbpath clearfix">
                                <li class="first"><a href=""></a></li><li><a href=""></a></li><li><a href=""></a></li><li class="last hier"><a href=""></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col3">
                                    <div class="contentbox alignright">
                                        <p class="readmore">
                                            <!--a target="_blank" href="https://www.onlinequizcreator.com/xyz/quiz-118985">Play the quiz</a-->							</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col9">
                            <div class="contentbox noLeftPadding">
                                ...
                                $selectSQL = "SELECT * FROM `quiz_master` WHERE Quiz_id = '{$_SESSION["Quiz_id"]}'";
                                ...
                                <div class="buttongroup">
                                    <a class="button addquestion" href="AQuestion_create.php">+ New question</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript" src="js/new/bootstrap-alerts.js"></script>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"9b458065c4","applicationID":"9256359","transactionName":"blFaMUVXDUBQVEVRV1cbbRdeGRBaRVIeUVZdUUBLR14T","queueTime":0,"applicationTime":318,"atts":"QhZZRw1NHk4=","errorBeacon":"bam.nr-data.net","agent":"js-agent.newrelic.com\/nr-686.min.js"}</script>
</body>
</html>