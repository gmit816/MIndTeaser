            ...
            <div class="wrapper clearfix">
                <div class="rowbox managecontainer">
                    ...
                    <div class="row">
                        ...
                        <div class="col9">
                            <div class="contentbox noLeftPadding">
                                <form class="quicknewquiz quizsettings" id="newquizformmodel" action="AUtilityQ.php" method="post">
                                    <fieldset>
                                        <div id="formdiv" style="display: none;">
                                            <div class="required">
                                                <label for="NewQuizFormModel_title" class="required">Title for your quiz&nbsp;
                                                    <span class="required">*</span>
                                                </label>
                                                <input placeholder="Title for your quiz" id="NewQuizFormModel_title" name="Quiz_name" type="text">
                                                <div class="errorMessage hide" id="NewQuizFormModel_title_em_">
                                                </div>
                                            </div>
                                        </div>
                                        <input class="addquiz button medium" type="submit" name="yt0" value="+ New quiz">
                                    </fieldset>
                                </form>
                                <?php
                                ...
                                $selectSQL = "SELECT * FROM `quiz_master` WHERE Quiz_owner='{$_SESSION["User_id"]}'";
                                ...
                                <table class="quizindex">
                                    ...
                                    <tr>
                                        <th>Quiz Title</th>
                                        <th class="alignright">Quiz Id</th>
                                        <th class="alignright">No. of Questions</th>
                                        <!--th class="alignright">Want to Add Question?</th-->
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php
                                    if (mysql_num_rows($selectRes) == 0) {
                                        ...
                                        while ($row = mysql_fetch_assoc($selectRes)) {
                                            $mit="SELECT * FROM `question_master` WHERE Quiz_id='{$row["Quiz_id"]}'";
                                            $r=mysql_query($mit,$con);
                                            $m=mysql_num_rows($r);
                                            echo "<tr><td>{$row['Quiz_name']}</td><td class=\"alignright\">{$row['Quiz_id']}</td><td class=\"alignright\">$m</td><!--td class=\"alignright\"><a href=\"Quiz_Dashboard.php\">Add Question</a></td--></tr>\n";
                                        }
                                    }
                                    }
                                    ?>
