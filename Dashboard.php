                    ...
                    <div class="row">
                        <div class="col3">
                            <div class="navigation quiznav">
                                <nav>
                                    <ul class="menu level1">
                                        <li class="hier open"><a href="Dashboard.php">Dashboard</a></li>
                        ...
                        <div class="col9">
                            <div class="contentbox noLeftPadding">
                                ...
                                <div class="userdash row">
                                    <a href="Quiz_play.php" class="col2_25 qtype equal1 type_quiz" style="height: 303px;">
                                        <h3>Gamified Quiz</h3>
                                    ...
                                    <a href="Profile.php" class="col2_25 qtype equal1 type_exam" style="height: 303px;">
                                        <h3>Quiz History</h3>
