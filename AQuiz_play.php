<!DOCTYPE html>
<!-- saved from url=(0066)https://www.onlinequizcreator.com/my-dashboard/my-quizzes/item3240 -->
...
<head>
    ...
    <meta name="description" content="Below are your quizzes.">
...
<div id="mm-0" class="mm-page mm-slideout">
    <div class="navbar mainnavbar">
        <div class="wrapper clearfix">
            ...
            <a class="navlink" id="show-main-navigation" href="https://www.onlinequizcreator.com/my-dashboard/my-quizzes/item3240#"></a>
    ...
    <div class="navbar menubar" style="position: relative;">
        <div class="wrapper clearfix">
            <div class="row">
                <div class="col8">
                    <div class="dashtabs">
                        <a class="navlink" id="show-quizmaster-navigation" href="https://www.onlinequizcreator.com/my-dashboard/my-quizzes/item3240#"></a>
                            ...
                            <div class="subnav navigation">
                                <nav>
                                    <ul class="menu level1">
                                        ...
                                        <li class="open hier haschildren">
                    ...
                    <div class="col12">
                        <nav>
                            <ul class="crumbpath clearfix">
                                <li class="first"><a href=""></a></li><li><a href=""></a></li><li class="last hier"><a href=""></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
            ...
            <div class="wrapper clearfix">
                <div class="rowbox managecontainer">
                    ...
                    <div class="row">
                        ...
                        <div class="col9">
                            <div class="contentbox noLeftPadding">
                                <form class="quicknewquiz quizsettings" id="newquizformmodel" action="AUtilityQuiz_play.php" method="post">
                                    <fieldset>
                                        <div id="formdiv" style="display: none;">
                                            <div class="required">
                                                <label for="NewQuizFormModel_title" class="required">Enter Valid Quiz Id&nbsp;
                                                    <span class="required">*</span>
                                                </label>
                                                <input placeholder="Enter Valid Quiz Id" id="NewQuizFormModel_title" name="Quiz_id" type="text" required="required">
                                                <div class="errorMessage hide" id="NewQuizFormModel_title_em_">
                                                </div>
                                            </div>
                                        </div>
                                        <input class="addquiz button medium" type="submit" name="yt0" value="Play Quiz >">
                                    </fieldset>
                                </form>
                                <?php
                                ...
                                ?>
                                <table class="quizindex"><tbody>
                                    <?php
                                    echo '<tr><td colspan="4">No Quiz Selected for playing.</td></tr></tbody></table>';
                                    }
                                    else
                                    {
                                    ...
                                    $selectSQL = "SELECT * FROM `question_master` WHERE Quiz_id='{$_SESSION["Quiz_id"]}'";
                                    # Execute the SELECT Query
                                    if (!($selectRes = mysql_query($selectSQL))){
                                        echo 'Retrieval of data from Database Failed - #' . mysql_errno() . ': ' . mysql_error();
                                    }else{
                                    ?>
                                    <form action="AUtilityScore.php" method="post">
                                        <table class="quizindex">
                                            <thead>
                                            <tr>
                                                <th>Quiz Id:</th>
                                                <td class=\"alignright\"><?php echo $_SESSION["Quiz_id"];?></td>
                                                <td>&nbsp;</td>
                                                <!--th class="alignright">Players</th-->
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <?php
                                            if (mysql_num_rows($selectRes) == 0) {
                                                echo '<tr><td colspan="4">No Questions Returned</td></tr>';
                                            } else {
                                                $gandhi = 1;
                                                while ($row = mysql_fetch_assoc($selectRes)) {
                                                    $mit = 'Question' . $gandhi;
                                                    $nij = 'Answer' . $gandhi;
//                                            $_SESSION["Que_id"]=$row["Que_id"];
                                                    $_SESSION[$nij] = $row["Answer"];
                                                    echo '<tr><th>Question ' . $gandhi . ':</th><td>' . $row['Question'] . '</td><td>&nbsp;</td></tr>
                                                <tr>
                                                <td></td>
                                                <td><input type="radio" name="' . $mit . '" value="' . $row['Option1'] . '" checked>' . $row['Option1'] . '</td>
                                                <td><input type="radio" name="' . $mit . '" value="' . $row['Option2'] . '">' . $row['Option2'] . '</td>
                                                </tr>
                                                <tr>
                                                <td></td>
                                                <td><input type="radio" name="' . $mit . '" value="' . $row['Option3'] . '">' . $row['Option3'] . '</td>
                                                <td><input type="radio" name="' . $mit . '" value="' . $row['Option4'] . '">' . $row['Option4'] . '</td>
                                                </tr>';
                                                    $gandhi++;
                                                }
                                                echo "<input type='hidden' name='question_count' value='" . $gandhi . "' />";
                                            }
                                            }
                                            }
                                            ?>
                                        ...
                                        <div class="button-container">
                                            <div class="clearfix row">
                                                <div class="col6 save-quiz">
                                                    <p>Done playing your quiz? Save it right away.</p>
                                                    <input class="save" name="save" type="submit" value="Submit">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
    ...
    jQuery(function($) {
        ...
        jQuery('#newquizformmodel').yiiactiveform({'validateOnSubmit':true,'afterValidate':function(form, data, hasError) {
            ...
            if(jQuery.trim(value)=='') {
                messages.push("Title for your quiz cannot be blank.");
            }
        }}],'errorCss':'error'});
    });
    /*]]>*/
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"9b458065c4","applicationID":"9256359","transactionName":"blFaMUVXDUBQVEVRV1cbbRdeGRBaRVIeUVZdUUBLR14T","queueTime":0,"applicationTime":452,"atts":"QhZZRw1NHk4=","errorBeacon":"bam.nr-data.net","agent":"js-agent.newrelic.com\/nr-686.min.js"}</script>
</body>
</html>