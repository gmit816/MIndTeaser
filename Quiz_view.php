                    ...
                    <div class="row">
                        ...
                        <div class="col9">
                            <div class="contentbox noLeftPadding">
                                ...
                                <form class="quicknewquiz quizsettings" id="newquizformmodel" action="UtilityQuiz_view.php" method="post">
                                    <fieldset>
                                ...
                                <table class="quizindex"><tbody>
                                    ...
                                    <br/>
                                    <br/>
                                    <center><a href="Dashboard.php">Back to Dashboard? Click Here!</a></center>
                            </div>
                        </div>
                    </div>
                </div>
