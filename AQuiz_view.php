            ...
            <div class="wrapper clearfix">
                <div class="rowbox managecontainer">
                    ...
                    <div class="row">
                        ...
                        <div class="col9">
                            <div class="contentbox noLeftPadding">
                                <form class="quicknewquiz quizsettings" id="newquizformmodel" action="AUtilityQuiz_view.php" method="post">
                                    <fieldset>
                                        ...
                                        <input class="addquiz button medium" type="submit" name="yt0" value="View Quiz >">
                                    </fieldset>
                                </form>
                                <?php
                                ...
                                <table class="quizindex"><tbody>
                                    <?php
                                    echo '<tr><td colspan="4">No Quiz Selected to view.</td></tr></tbody></table>';
                                    }
                                    else
                                    {
                                    ...
                                    ?>
                                    <form action="UtilityDelete.php" method="post">
                                        <table class="quizindex">
                                            ...
                                            if (mysql_num_rows($selectRes) == 0) {
                                                ...
                                                <tr>
                                                <td></td>
                                                <td>Option1:&nbsp;' . $row['Option1'] . '</td>
                                                <td>Option2:&nbsp;' . $row['Option2'] . '</td>
                                                </tr>
                                                <tr>
                                                <td></td>
                                                <td>Option3:&nbsp;' . $row['Option3'] . '</td>
                                                <td>Option4:&nbsp;' . $row['Option4'] . '</td>
                                                </tr>
                                                <tr>
                                                <td></td>
                                                <td>Answer:&nbsp;' . $row['Answer'] . '</td>
                                                <td></td>
                                                </tr>';
                                                    $gandhi++;
                                                }
                                                echo "<input type=hidden name=\"quiz_id\" value=\"{$_SESSION["Quiz_id"]}\">";
                                                unset($_SESSION['Quiz_id']);
                                            }
                                            }
                                            }
                                        ...
                                        <div class="button-container">
                                            <div class="clearfix row">
                                                <div class="col12">
                                                    <p>Want to Delete?Sure?</p>
                                                    <input class="save" name="save" type="submit" value="Delete Quiz">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                    <br/>
                                    <br/>
                                    <center><a href="ADashboard.php">Back to Dashboard? Click Here!</a></center>
                            </div>
                        </div>
                    </div>
                </div>
