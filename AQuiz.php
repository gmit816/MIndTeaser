                            ...
                            <div class="navigation quiznav">
                                <nav>
                                    <ul class="menu level1">
                                        ...
                                        <li class="hier open"><a href="AQuiz.php">Quiz</a></li>
                        ...
                        <div class="col9">
                            <div class="contentbox noLeftPadding">
                                ...
                                <div class="userdash row">
                                    <a href="AQuiz_create.php" class="col2_25 qtype equal1 type_quiz" style="height: 200px;">
                                        <h3>Create Quiz</h3>
                                        <p>Create your own personalized Quiz by just clicking this and following the few steps</p>
                                        <span>To Create Quiz</span>
                                    </a>
                                    <a href="AQuiz_play.php" class="col2_25 qtype equal1 type_assessment" style="height: 303px;">
                                        <h3>Play Quiz</h3>
                                        <p>Play the pre-created quiz.Test Your brains by just clicking this and get your result</p>
                                        <span>To Play Quiz</span>
                                    </a>
                                    <a href="AQuiz_view.php" class="col2_25 qtype equal1 type_assessment" style="height: 303px;">
                                        <h3>View/Delete Quiz</h3>
                                        <p>View/Delete the quizzes.View/Delete quizzes by just clicking this.</p>
