                            ...
                            <div class="subnav navigation">
                                <nav>
                                    <ul class="menu level1">
                                        <li class="first hier haschildren">
            ...
            <div class="wrapper clearfix">
                <div class="rowbox managecontainer">
                    <div class="row border_bottom manageheader">
                        <div class="col3">
                            <div class="contentbox">
                                <strong class="heading h3">Dashboard</strong>
                            </div>
                        </div>
                        <div class="col9">
                            <div class="row">
                    ...
                    <div class="row">
                        <div class="col3">
                            <div class="navigation quiznav">
                                <nav>
                                    <ul class="menu level1">
                                        <li class="hier open"><a href="ADashboard.php">Dashboard</a></li>
                        ...
                        <div class="col9">
                            <div class="contentbox noLeftPadding">
                                <div class="pagecontent">
                                    <div class="intro">
                                        <p>Welcome to your personal dashboard. From this altitude you have a great overview of the possibilities. Now quickly fly to your quizzes or assessments.</p>
                                    </div>
                                </div>
                                <div class="userdash row">
                                    <a href="AQuiz_play.php" class="col2_25 qtype equal1 type_quiz" style="height: 303px;">
                                        <h3>Gamified Quiz</h3>
                                        <p>Play Quizzes created by other users and score maximum marks to improve your experience level.</p>
                                        <span>To Quizzes</span>
                                        <!--h3>Under Construction!</h3-->
                                    </a>
                                    <a href="#" class="col2_25 qtype equal1 type_assessment" style="height: 303px;">
                                        <h3>Challenges!</h3>
                                        <p>Challenge your friends and family for Extraordinary Quizzes. </p>
                                        <span>Under Construction!</span>
                                        <!--h3>Under Construction!</h3-->
                                    </a>
                                    <a href="AProfile.php" class="col2_25 qtype equal1 type_exam" style="height: 303px;">
                                        <h3>Quiz History</h3>
                                        <p>User can track his/her records of quiz, either of created quiz or played quiz.</p>
