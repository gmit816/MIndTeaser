            ...
            <div class="wrapper clearfix">
                <div class="rowbox managecontainer">
                    ...
                    <div class="row">
                        ...
                        <div class="col9">
                            <div class="contentbox noLeftPadding">
                                <form class="quicknewquiz quizsettings" id="newquizformmodel" action="UtilityQ.php" method="post">
                                    <fieldset>
                                        <div id="formdiv" style="display: none;">
                                            <div class="required">
                                                ...
                                                <input placeholder="Title for your quiz" id="NewQuizFormModel_title" name="Quiz_name" type="text" required="required">
