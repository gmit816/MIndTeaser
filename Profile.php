                            ...
                            <div class="navigation quiznav">
                                <nav>
                                    <ul class="menu level1">
                                        ...
                                        <li class="hier open"><a href="Profile.php">Profile</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                        <div class="col9">
                            <div class="contentbox noLeftPadding">
                                <div class="pagecontent">
                                    <div class="intro">
                                        <p>Welcome to your personal profile. From this altitude you can check your created quiz and their attempts and played quiz and score too.</p>
                                    </div>
                                </div>
                                ...
                                <table>
                                    ...
                                    if (mysql_num_rows($selectRes) == 0) {
                                        ...
                                        while ($row = mysql_fetch_assoc($selectRes)) {
                                            ...
                                            <tr><th>Password:</th><td><a href=\"Password_change.php\">Change Password?</a></td><td></td></tr>";
                                        }
                                    }
                                    }
                                    ?>
